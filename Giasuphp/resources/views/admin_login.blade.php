...
<head>
  ...
  <link href="{{asset('public/backend/css/icons.css')}}" rel="stylesheet"/>
  ...
  <!--Start sidebar-wrapper-->
   <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
     <div class="brand-logo">
      <a href="index.html">
      <img src="https://image.thanhnien.vn/220x150/uploaded/haoph/2021_03_06/img_0467_lsvb.jpg" class="logo-icon" alt="logo icon">
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="icons.html">
          <i class="zmdi zmdi-invert-colors"></i> <span>Danh sách lớp học</span>
        </a>
      </li>
